...
#define PTE_VM_FLAGS (PTE_MEMATTR_NRML_OWBC | PTE_MEMATTR_NRML_IWBC | PTE_SH_NS | PTE_S2AP_RW | PTE_AF)
//#define PTE_VM_FLAGS (PTE_MEMATTR_NRML_OWBC | PTE_MEMATTR_NRML_IWBC | PTE_S2AP_RW | PTE_AF)//
//#define PTE_VM_FLAGS (PTE_MEMATTR_NRML_ONC | PTE_MEMATTR_NRML_INC)

//#define PTE_VM_FLAGS (PTE_MEMATTR_NRML_ONC | PTE_SH_NS | PTE_S2AP_RW | PTE_AF)
