...
void gicv2_pmu_handler()
{
	//printk("gicv2_pmu_handler()\n");
	//vcpu_inject_irq(cpu()->vcpu, 32);
	//interrupts_cpu_enable(174, true);
}
...
static inline void gicc_init()
{
	...
	/* interrupts_reserve(48, gicv2_pmu_handler); */
	/* interrupts_reserve(49, gicv2_pmu_handler); */
	/* interrupts_reserve(50, gicv2_pmu_handler); */
	/* interrupts_reserve(51, gicv2_pmu_handler); */
	/* interrupts_reserve(platform.arch.gic.p4, gicv2_pmu_handler); */
	/* interrupts_reserve(platform.arch.gic.p5, gicv2_pmu_handler); */
	/* interrupts_reserve(platform.arch.gic.p6, gicv2_pmu_handler); */
	/* interrupts_reserve(platform.arch.gic.p7, gicv2_pmu_handler); */
	/* interrupts_reserve(platform.arch.gic.p8, gicv2_pmu_handler); */
}
