...
//   nsubs_pt = (iArray *)snsubs_pt; // malloc(sizeof(iArray) +
//   sizeof(int)*ndims);
//
//   strides_pt = (uiArray *)
...
//       */
//       if (good && nindex != index && forest_pt[nindex].parent !=
//       node_is_void) {
...
//     // printf("ulliArray %d %d \n", sizeof(ulliArray),
//     // sizeof(acc_t)*gdl*nmer);
//
//     acc_pt = (ulliArray *)sacc_pt; // malloc(sizeof(ulliArray) +
//         sizeof(acc_t)*nel) ;
//         ell_pt = (ulliArray *)
...
//             if (region-- == 0)
//               continue;
//             sref(ell_pt, d + gdl * region) = sref(acc_pt,
//             regions_pt[i].index);
//           }
//
//           /* next gdl */
