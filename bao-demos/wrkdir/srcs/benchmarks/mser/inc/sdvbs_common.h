...
FILE * nofs_fopen(const char * objptr, const char * mode);
size_t nofs_fread(void * dest, size_t size, size_t count, FILE * fp);
size_t nofs_fwrite(void * dest, size_t block_size, size_t blocks, FILE * file);
void   nofs_fseek(FILE * file, size_t offset, int whence);
void   nofs_fclose(FILE * file);
